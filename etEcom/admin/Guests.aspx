<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Sellers.Master" AutoEventWireup="true" CodeBehind="Guests.aspx.cs" Inherits="etEcom.admin.Guests" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:Label ID="lblState" runat="server" Text="State" Width="249px"></asp:Label>
