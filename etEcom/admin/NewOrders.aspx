<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewOrders.aspx.cs" Inherits="etEcom.admin.NewOrders" MasterPageFile="~/admin/Sellers.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <br />
    <asp:Label ID="lblMember" runat="server" Text="Member Name" Width="171px"></asp:Label>
    ...
    <asp:GridView ID="grdviewNewOrders" runat="server" Width="100%" Height="100%" HeaderStyle-BackColor="#3F8CD6" AllowPaging="true" RowStyle-CssClass="GvGrid"
        HeaderStyle-ForeColor="White" RowStyle-BackColor="#77AEE1" AlternatingRowStyle-BackColor="White"
        RowStyle-ForeColor="#3A3A3A" AutoGenerateColumns="false" PageSize="10" OnRowCommand="grdviewNewOrders_RowCommand">
        <Columns>
