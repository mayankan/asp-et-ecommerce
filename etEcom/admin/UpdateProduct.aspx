<%@ Page Title="" Language="C#" MasterPageFile="~/admin/Sellers.Master" AutoEventWireup="true" CodeBehind="UpdateProduct.aspx.cs" Inherits="etEcom.admin.UpdateProduct" %>
    ...
    <div style="height: 100%; width: 100%; float: left;">
        ...
        <div style="height: 100%; width: 30%; float: left; border: 1px solid black;" id="categoryDiv">
            ...
            <br />
                ...
                <asp:Label ID="lblSuccessfulCategory" runat="server" Text="" ForeColor="ForestGreen"></asp:Label>
            </div>
            ...
            <div id="addInput1" style="display: block;">
                ...
                <br />
                <asp:Button ID="btnCategory" runat="server" Text="Update Category" CssClass="button" OnClick="btnCategory_Click" ValidationGroup="Category" />
                <asp:Button ID="btnDeleteCat" runat="server" Text="Delete Category" CssClass="button" ValidationGroup="Category" OnClick="btnDeleteCat_Click" />
        ...
        <div style="height: 100%; width: 30%; float: left; border: 1px solid black;" id="brandDiv">
            ...
            <br />
                ...
                <asp:Label ID="lblSuccessfulBrand" runat="server" Text="" ForeColor="ForestGreen"></asp:Label>
                <br />
            </div>
            ...
            <br />
                <br />
                <br />
                <asp:Button ID="btnBrand" runat="server" Text="Update Brand" CssClass="button" OnClick="btnBrand_Click" ValidationGroup="Brand" />
                <asp:Button ID="btnDelBrand" runat="server" Text="Delete Brand" CssClass="button" ValidationGroup="brand" OnClick="btnDelBrand_Click" />
            </div>
        </div>
        <div style="height: 100%; width: 40%; float: left; border: 1px solid black;" id="productDiv">
            ...
            <br />
                ...
                <asp:Label ID="lblSuccessfulProduct" runat="server" ForeColor="ForestGreen"></asp:Label>
                <br />
                <br />
            </div>
            ...
            <asp:RequiredFieldValidator ID="valDispatchTime" runat="server" ControlToValidate="ddlDispatchTime" ErrorMessage="*" Font-Size="Medium" ForeColor="Red" ValidationGroup="Product"></asp:RequiredFieldValidator>
                ...
                <asp:Button ID="btnProduct" runat="server" OnClick="btnProduct_Click" Text="Update Product" CssClass="button" Width="227px" ValidationGroup="Product" />
                <asp:Button ID="btnDelProd" runat="server" CssClass="button" Text="Delete Product" Width="227px" ValidationGroup="Product" OnClick="btnDelProd_Click" />
                <%----%>
            </div>
        </div>
    </div>
